...
set wrapperDistributionUrl=https\://mirrors.tuna.tsinghua.edu.cn/macports/distfiles/gradle/
...
:: generated by chat gpc begin
:: get the version from defaultDistributionUrl
@setlocal enabledelayedexpansion
set "reversed="
for /l %%i in (0,1,999) do (
    set "char=!defaultDistributionUrl:~%%i,1!"
    if "!char!"=="" goto :got_reverse
...
set "started="
for /l %%i in (0,1,999) do (
    set "char=!reversed:~%%i,1!"
    if "!char!"=="" goto :got_part
    if "!char!"=="/" (
        if defined started (
            goto :got_part
        ) else (
    ...
    ) else if defined started (
        set "part1=!char!!part1!"
    )
)
:got_part
@endlocal & set version=%part1%
:: generated by chat gpc end
echo version=%version%
set wrapperDistributionUrl=https://mirrors.tuna.tsinghua.edu.cn/apache/maven/maven-3/%version%/binaries/
